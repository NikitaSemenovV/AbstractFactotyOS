...
namespace AbstractFactotyOS
{
    ...
    class Macos_swith : swith
    {
        ...
        public string getSet9()
        {
            ...
            {
                if (getSettings()[8] == 1)
                    return "Отображение лого Apple при загрузке: вкл\n9. Выключить";
                else
                    return "Отображение лого Apple при загрузке: выкл\n9. Включить";
            }
            else
            {
                if (getSettings()[8] == 1)
                    return "Apple`s logo on boot: enabled\n9. Disable";
                else
                    return "Apple`s logo on boot: disable\n9. Enable";
            }
        }
